	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		legend style={
	     ...
	     % \xdef\C{5e-8}
	     % \xdef\R{13000}
		\addplot +[mark=*, line width=0.4pt, mark size=0.4pt, solid,lightgreen] plot [error bars/.cd, y dir = both, y explicit,x dir = both, x explicit] table [ x=e1, y=ic, y error=di, x error=du] {../data/ex4.tsv};
